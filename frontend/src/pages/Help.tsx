...
export default function Help() {
  ...
  const content = [
    ...
    {text: 'Learning the guitar fretboard makes it easier to build chords, play scales    \n', className: 'text-fg'},
    {text: 'and improvise across the neck without relying on fixed shapes and patterns.   \n\n', className: 'text-fg'}, 
    {text: 'This app is designed to teach the notes of the fretboard using daily, five-   \n', className: 'text-fg'},
    {text: 'minute lessons. It uses a ', className: 'text-fg'},
    {
